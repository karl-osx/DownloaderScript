...
mapping = (
    ...
    ('Sinkhole-DNS', 'event4_sinkhole_dns'),
    ('Sinkhole-Events-HTTP IPv4', 'event4_sinkhole_http'),
    ('Sinkhole-Events-HTTP-Referer IPv4', 'event4_sinkhole_http_referer'),
    ('Sinkhole-Events IPv6', 'event6_sinkhole'),
    ('Sinkhole-Events-HTTP IPv6', 'event6_sinkhole_http'),
    ('Sinkhole-Events-HTTP-Referer IPv6', 'event6_sinkhole_http_referer'),
    ('Malware-URL', 'malware_url'),
    ('Phish-URL', 'phish_url'),
    ('IPv6-Accessible-HTTP-Proxy', 'population6_http_proxy'),
    ('Accessible-HTTP-Proxy', 'population_http_proxy'),
    ('Sandbox-Connections', 'sandbox_conn'),
    ('Sandbox-DNS', 'sandbox_dns'),
    ('Sandbox-URL', 'sandbox_url'),
    ('IPv6-Accessible-CWMP', 'scan6_cwmp'),
    ('IPv6-DNS-Open-Resolvers', 'scan6_dns'),
    ('IPv6-Vulnerable-Exchange', 'scan6_exchange'),
    ('IPv6-Accessible-FTP', 'scan6_ftp'),
    ('IPv6-Accessible-HTTP', 'scan6_http'),
    ('IPv6-Open-HTTP-Proxy', 'scan6_http_proxy'),
    ('IPv6-Vulnerable-HTTP', 'scan6_http_vulnerable'),
    ('IPv6-Open-IPP', 'scan6_ipp'),
    ('IPv6-Open-LDAP-TCP', 'scan6_ldap_tcp'),
    ('IPv6-Open-MQTT', 'scan6_mqtt'),
    ('IPv6-Open-Anonymous-MQTT', 'scan6_mqtt_anon'),
    ('IPv6-Accessible-MySQL', 'scan6_mysql'),
    ('IPv6-NTP-Version', 'scan6_ntp'),
    ('IPv6-NTP-Monitor', 'scan6_ntpmonitor'),
    ('IPv6-Accessible-PostgreSQL', 'scan6_postgres'),
    ('IPv6-Accessible-RDP', 'scan6_rdp'),
    ('IPv6-Accessible-SLP', 'scan6_slp'),
    ('IPv6-Accessible-SMB', 'scan6_smb'),
    ('IPv6-Accessible-SMTP', 'scan6_smtp'),
    ('IPv6-Vulnerable-SMTP', 'scan6_smtp_vulnerable'),
    ('IPv6-Open-SNMP', 'scan6_snmp'),
    ('IPv6-Accessible-SSH', 'scan6_ssh'),
    ('IPv6-Accessible-SSL', 'scan6_ssl'),
    ('SSL-FREAK-Vulnerable-Servers IPv6', 'scan6_ssl_freak'),
    ('SSL-POODLE-Vulnerable-Servers IPv6', 'scan6_ssl_poodle'),
    ('IPv6-Accessible-Session-Traversal-Utilities-for-NAT', 'scan6_stun'),
    ('IPv6-Accessible-Telnet', 'scan6_telnet'),
    ('IPv6-Accessible-VNC', 'scan6_vnc'),
    ('Accessible-ADB', 'scan_adb'),
    ('Accessible-AFP', 'scan_afp'),
    ('Accessible-AMQP', 'scan_amqp'),
    ('Accessible-ARD', 'scan_ard'),
    ('Open-Chargen', 'scan_chargen'),
    ('Accessible-Cisco-Smart-Install', 'scan_cisco_smart_install'),
    ('Accessible-CoAP', 'scan_coap'),
    ('Accessible-CouchDB', 'scan_couchdb'),
    ('Accessible-CWMP', 'scan_cwmp'),
    ('Open-DB2-Discovery-Service', 'scan_db2'),
    ('Vulnerable-DDoS-Middlebox', 'scan_ddos_middlebox'),
    ('DNS-Open-Resolvers', 'scan_dns'),
    ('Accessible-Docker', 'scan_docker'),
    ('Accessible-DVR-DHCPDiscover', 'scan_dvr_dhcpdiscover'),
    ('Open-Elasticsearch', 'scan_elasticsearch'),
    ('Accessible-Erlang-Port-Mapper-Daemon', 'scan_epmd'),
    ('Vulnerable-Exchange-Server', 'scan_exchange'),
    ('Accessible-FTP', 'scan_ftp'),
    ('Accessible-Hadoop', 'scan_hadoop'),
    ('Accessible-HTTP', 'scan_http'),
    ('Open-HTTP-Proxy', 'scan_http_proxy'),
    ('Vulnerable-HTTP', 'scan_http_vulnerable'),
    ('Accessible-ICS', 'scan_ics'),
    ('Open-IPMI', 'scan_ipmi'),
    ('Open-IPP', 'scan_ipp'),
    ('Vulnerable-ISAKMP', 'scan_isakmp'),
    ('Accessible-Kubernetes-API', 'scan_kubernetes'),
    ('Open-LDAP-TCP', 'scan_ldap_tcp'),
    ('Open-LDAP', 'scan_ldap_udp'),
    ('Open-mDNS', 'scan_mdns'),
    ('Open-Memcached', 'scan_memcached'),
    ('Open-MongoDB', 'scan_mongodb'),
    ('Open-MQTT', 'scan_mqtt'),
    ('Open-Anonymous-MQTT', 'scan_mqtt_anon'),
    ('Open-MSSQL', 'scan_mssql'),
    ('Accessible-MySQL', 'scan_mysql'),
    ('Open-NATPMP', 'scan_nat_pmp'),
    ('Open-NetBIOS-Nameservice', 'scan_netbios'),
    ('Open-Netis', 'scan_netis_router'),
    ('NTP-Version', 'scan_ntp'),
    ('NTP-Monitor', 'scan_ntpmonitor'),
    ('Open-Portmapper', 'scan_portmapper'),
    ('Accessible-PostgreSQL', 'scan_postgres'),
    ('Open-QOTD', 'scan_qotd'),
    ('Accessible-QUIC', 'scan_quic'),
    ('Accessible-Radmin', 'scan_radmin'),
    ('Accessible-RDP', 'scan_rdp'),
    ('Accessible-MS-RDPEUDP', 'scan_rdpeudp'),
    ('Open-Redis', 'scan_redis'),
    ('Accessible-Rsync', 'scan_rsync'),
    ('Accessible-SIP', 'scan_sip'),
    ('Accessible-SLP', 'scan_slp'),
    ('Accessible-SMB', 'scan_smb'),
    ('Accessible-SMTP', 'scan_smtp'),
    ('Vulnerable-SMTP', 'scan_smtp_vulnerable'),
    ('Open-SNMP', 'scan_snmp'),
    ('Accessible-SOCKS4/5-Proxy', 'scan_socks'),
    ('Open-SSDP', 'scan_ssdp'),
    ('Accessible-SSH', 'scan_ssh'),
    ('Accessible-SSL', 'scan_ssl'),
    ('SSL-FREAK-Vulnerable-Servers', 'scan_ssl_freak'),
    ('SSL-POODLE-Vulnerable-Servers IPv4', 'scan_ssl_poodle'),
    ('Accessible-Session-Traversal-Utilities-for-NAT', 'scan_stun'),
    ('SYNful-Knock', 'scan_synfulknock'),
    ('Accessible-Telnet', 'scan_telnet'),
    ('Open-TFTP', 'scan_tftp'),
    ('Accessible-Ubiquiti-Discovery-Service', 'scan_ubiquiti'),
    ('Accessible-VNC', 'scan_vnc'),
    ('Accessible-WS-Discovery-Service', 'scan_ws_discovery'),
    ('Open-XDMCP', 'scan_xdmcp'),
    ('Spam-URL', 'spam_url'),
    ('Special', 'special'),
    ('Accessible-RDPEUDP', 'scan_rdpeudp'),
    ('Sinkhole-Events', 'event4_sinkhole'),
    ('Sinkhole-Events-HTTP', 'event4_sinkhole_http'),
...
filename_mapping = {filename: feedname for feedname, filename in mapping}